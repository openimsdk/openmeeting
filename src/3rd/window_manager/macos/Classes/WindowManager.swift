...
public class WindowManager: NSObject, NSWindowDelegate {
    ...
    public func setTitleBarStyle(_ args: [String: Any]) {
        ...
        let zoomButtonVisibility = args["zoomButtonVisibility"] as! Bool
        ...
        mainWindow.standardWindowButton(.zoomButton)?.isHidden = !(windowButtonVisibility && zoomButtonVisibility)
    }
