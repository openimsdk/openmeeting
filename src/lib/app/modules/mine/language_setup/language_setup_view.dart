      ...
      body: Obx(() => Column(
            children: [
              ...
              _buildItemView(
                ...
                isChecked: controller.isFollowSystem.value,
                onTap: () => controller.switchLanguage(0),
                isTopRadius: true,
              ),
              Container(
              ...
              _buildItemView(
                ...
                isChecked: controller.isChinese.value,
                onTap: () => controller.switchLanguage(1),
              ),
              Container(
                margin: EdgeInsets.only(left: 26.w, right: 10.w),
                color: Styles.c_E8EAEF,
              ...
              _buildItemView(
                ...
                isChecked: controller.isEnglish.value,
                onTap: () => controller.switchLanguage(2),
                isBottomRadius: true,
              ),
            ],
          )),
